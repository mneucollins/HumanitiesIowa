...
<?php responsive_widgets_before(); // above widgets container hook ?>
	...
	<div id="widgets" class="home-widgets">
		<div id="home_widget_4" class="grid col-940">
		...
		<div align="center" class="grid col-940">
			<?php     //inserting slideshow here--------------------------------------------------
 				do_action('slideshow_deploy', '342'); 
			?>
		</div>
		...
		<div id="home_widget_2" class="grid col-460">
		...
		<div id="home_widget_3" class="grid col-460 fit">
			<?php responsive_widgets(); // above widgets hook ?>
