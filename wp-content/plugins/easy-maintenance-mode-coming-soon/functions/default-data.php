...
********************************************************************/	
		...
		add_option("easy_maintenance_mode_general_settings", $general_setting_save);
...
********************************************************************/
		...
		// data is insert into option table
		add_option("easy_maintenance_mode_text_design_setting", $text_design_setting_save);
...
********************************************************************/
		...
		// data is insert into option table
		add_option("easy_maintenance_mode_background_setting_save", $background_setting_save);
